...
## 2. Filtered panel (exclude selected categories)

- `panel_data_filtered.csv`

A filtered version of the main panel dataset used for robustness checks that
exclude selected categories (transportation, energy, communication).

Generated by:

- `code/ch01/03_expectation_formation/07_build_panel_data_filtered.R`
